      ...
      <div className="max-w-screen-xl mx-auto p-4 flex flex-col items-center justify-center">
        <div className="flex space-x-4 mb-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href="https://linkedin.com/in/lakmina-gamage" target="_blank" rel="noopener noreferrer">
              <Linkedin className="h-6 w-6" />
              <span className="sr-only">LinkedIn profile</span>
            </Link>
          </Button>
          <Button variant="ghost" size="icon" asChild>
            <Link href="https://github.com/lakminagamage" target="_blank" rel="noopener noreferrer">
